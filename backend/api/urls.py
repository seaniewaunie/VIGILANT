...
urlpatterns = [
	...
	re_path(r'^gfilter/start_date=(?P<start_date>.*)&end_date=(?P<end_date>.*)&start_time=(?P<start_time>.*)&end_time=(?P<end_time>.*)&days=(?P<days>\[(\w*)(,*\w*)*\])&descriptions=(?P<codes>.*)&districts=(?P<districts>\[(\w*)(,*\w*)*\])&weapons=(?P<weapons>\[(\w*)(,*\w*)*\])&start_lat=(?P<start_lat>.*)&end_lat=(?P<end_lat>.*)&start_long=(?P<start_long>.*)&end_long=(?P<end_long>.*)&i_o=(?P<i_o>\[(\w*)(,*\w*)*\])$', views.GlobalFilterStructured.as_view()),
	re_path(r'^start_date=(?P<start_date>.*)&end_date=(?P<end_date>.*)&start_time=(?P<start_time>.*)&end_time=(?P<end_time>.*)&days=(?P<days>\[(\w*)(,*\w*)*\])&descriptions=(?P<codes>.*)&districts=(?P<districts>\[(\w*)(,*\w*)*\])&weapons=(?P<weapons>\[(\w*)(,*\w*)*\])&start_lat=(?P<start_lat>.*)&end_lat=(?P<end_lat>.*)&start_long=(?P<start_long>.*)&end_long=(?P<end_long>.*)&i_o=(?P<i_o>\[(\w*)(,*\w*)*\])$', views.GlobalFilterRawData.as_view()),
	path('codelookup/', views.CrimeCodeLookup.as_view()),
	re_path(r'^add/name=(?P<name>.*)&type=(?P<type>.*)&field=(?P<field>.*)$', views.AddVisualization.as_view()),
